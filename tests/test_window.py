...
def test_open_dialog_filter_includes_pdf(qtbot, monkeypatch):
    ...
    assert "*.hpp" in captured[0]
    assert "*.cc" in captured[0]
    assert "*.cxx" in captured[0]
    assert "*.hh" in captured[0]
    assert "*.hxx" in captured[0]
    assert "*.inl" in captured[0]
    assert "*.ipp" in captured[0]
